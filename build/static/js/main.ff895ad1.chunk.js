  ...
  [0],
  {
    ...
    664: function(e, t, a) {
      ...
      var n = a(0),
        ...
        d = (a(368), a(26)),
        p = a(77),
        b = { message: null, messageType: null },
        E = a(32),
        g = a(25),
        f = a(128),
        h = a.n(f),
        v = (a(580), a(582), a(584), a(236));
      h.a.initializeApp({
      ...
      var w = (window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ || E.c)(
          Object(g.reactReduxFirebase)(h.a, { userProfile: "users" }),
          Object(v.reduxFirestore)(h.a)
        )(E.d),
        N = Object(E.b)({
          ...
          setting: function() {
            ...
            switch (t.type) {
              case "DISABLE_ROBOTS_ON_ADD":
                return Object(p.a)({}, e, { disableRobotsOnAdd: t.payload });
              case "DISABLE_ROBOTS_ON_EDIT":
                return Object(p.a)({}, e, { disableRobotsOnEdit: t.payload });
              case "ALLOW_REGISTRATION":
                return Object(p.a)({}, e, { allowRegistration: t.payload });
              default:
                return e;
            }
          }
      ...
      var y = w(N, { setting: JSON.parse(localStorage.getItem("setting")) }),
                ...
                value: function() {
                  var e = this,
                    ...
                    r = z.a.map(a, function(e) {
                      return Object(p.a)({ name: e.firstName + e.lastName }, e);
                    }),
                      ...
                      l.a.createElement(
                        ...
                        l.a.createElement(
                          ...
                          l.a.createElement(
                            le.a,
                            null,
                            l.a.createElement(le.a.Checkbox, {
        ...
        ce = function(e) {
          ...
          return l.a.createElement(
            ...
            l.a.createElement(
              ...
              l.a.createElement(
                te.a.Item,
                { onClick: r, as: K.a, to: "/home" },
                "Home"
              ),
              l.a.createElement(
                te.a.Item,
                { onClick: r, to: "/createRobot", as: K.a },
                "Create Robot"
              ),
              l.a.createElement(
                te.a.Item,
                { onClick: r, as: K.a, to: "/viewRobots" },
                "View Robots"
              ),
              a
                ? l.a.createElement(
                ...
                : l.a.createElement(
                    ...
                    l.a.createElement(
                      te.a.Item,
                      { onClick: r, to: "/login", as: K.a },
                      "Login"
                    ),
                    l.a.createElement(
                      te.a.Item,
                      { onClick: r, to: "/signUp", as: K.a },
                      "Sign up"
                    )
                  )
            ),
            l.a.createElement(
              ...
              l.a.createElement(
                ...
                l.a.createElement(
                  te.a.Item,
                  null,
                  l.a.createElement(A.a, { size: "mini", src: $.a })
                ),
                l.a.createElement(
                  te.a.Item,
                  null,
                ...
                l.a.createElement(
                  ...
                  l.a.createElement(ae.a, { name: "sidebar" })
                )
              ),
              t
            )
        ...
        me = function(e) {
          var t = e.children;
          return l.a.createElement(oe.a, { style: { marginTop: "5em" } }, t);
        },
        ue = function(e) {
                  ...
                  value: function() {
                    return (
                      Ee()(document).ready(function() {
                        ...
                        Ee()("header nav ul li a").click(function(e) {
                          e.preventDefault();
                          var t = Ee()(this).attr("href"),
                            a = Ee()(t).position();
                          a &&
                            Ee()(window).scrollTo(
                              { top: a.top, left: "0px" },
                          ...
                          Ee()(".app_link").click(function(e) {
                            e.preventDefault(),
                              Ee()(window).scrollTo(
                                {
                                  top: Ee()("#hero").position().top,
                                  left: "0px"
                                },
                                1e3
                              );
                          }),
                          Ee()(".burger_icon").click(function() {
                            Ee()("header nav").toggleClass("show"),
                              Ee()("header .burger_icon").toggleClass("active");
                          }),
                          new fe.a({
                          ...
                          Ee()("#submit_form").submit(function() {
                            Ee()("#mc_submit").attr("disabled", "disabled"),
                              e("icon", "loading");
                          }),
                          Ee()("#submit_form").length &&
                            Ee()("#submit_form").ajaxChimp({
                              callback: function(t) {
                                "success" === t.result
                                  ? (e("loading", "icon"),
                                    Ee()("#mc_submit").removeAttr(
                                      "disabled",
                                      "disabled"
                                    ),
                                    Ee()("#submit_form #mc-email").val(""),
                                    Ee()("#error_msg").hide(),
                                    Ee()("#success_msg").show())
                                  : (e("loading", "icon"),
                                    Ee()("#success_msg").hide(),
                          ...
                          Ee()("#play_video").click(function(e) {
                            e.preventDefault();
                            var t = Ee()(this).data("video");
                            (t =
                              '<iframe src="' +
                              t +
                          ...
                          Ee()(".close_video").click(function(e) {
                            e.preventDefault(),
                              Ee()(".about_video").fadeOut(200, function() {
                                Ee()("iframe", this).remove();
                              });
                          });
                      }),
                      l.a.createElement(
                        ...
                        l.a.createElement(
                          ...
                          l.a.createElement(
                            ...
                            l.a.createElement(
                              ...
                              {
                                className:
                                  "logo pull-left animated wow fadeInLeft"
                              },
                              l.a.createElement("img", {
                            ...
                            l.a.createElement(
                              ...
                              l.a.createElement(
                                ...
                                l.a.createElement(
                                  "li",
                                  {
                                    className: "animated wow fadeInLeft",
                                    "data-wow-delay": "0s"
                                  },
                                  l.a.createElement(
                                    "a",
        ...
        ke = a(240),
        Ce = Re()({}),
        Ae = Object(ke.connectedRouterRedirect)({
          wrapperDisplayName: "UserIsAuthenticated",
          AuthenticatingComponent: H.a,
          allowRedirectBack: !0,
          redirectPath: function(e, t) {
            return Ce.getRedirectQueryParam(t) || "/login";
          },
        ...
        Le = Object(ke.connectedRouterRedirect)({
          wrapperDisplayName: "UserIsNotAuthenticated",
          AuthenticatingComponent: H.a,
          allowRedirectBack: !1,
          redirectPath: function(e, t) {
            return Ce.getRedirectQueryParam(t) || "/";
          },
          authenticatingSelector: function(e) {
            var t = e.firebase,
              a = t.auth,
      ...
      a(663);
      r.a.render(l.a.createElement(De, null), document.getElementById("root")),
...
//# sourceMappingURL=main.ff895ad1.chunk.js.map
